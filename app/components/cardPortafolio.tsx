...
export default function CardPortafolio({id,title,typo,desc,desc2,tec,img,repo,url} : any){
    ...
    return(
        <div className="flex-col h-[650px] mt-72 sm:mt-40 mb-52 ">
            ...
            <div className={`flex flex-col-reverse ${id%2 == 1? "items-center sm:items-start sm:flex-row" : "sm:flex-row-reverse"} sm:h-[450px] sm:mt-1 `}>
                <div className="relative sm:w-1/2 flex flex-col sm:h-full sm:justify-center">
                ...
                <div className={`w-full sm:w-1/2 ${id%2 == 1? " sm:ml-5 mt-2 sm:mt-0" : "mr-10 mt-5 sm:mt-0"} `}>
                    <Image src={img[0]}
